...
$string['dynamoremovegroupnoprobs']           = 'Afficher/Cacher les groupes sans problémes';
$string['dynamoremovegroupnotcomplete']       = 'Afficher/Cacher les groupes incomplets';
$string['dynamoswitchoverview']               = 'Changer de vue';
$string['dynamorepbtsynthesis']               = 'Afficher/Cacher synthèse';
$string['dynamorepbtsnif']                    = 'Afficher/Cacher NIWF';
$string['dynamorepbtevalothers']              = 'Afficher/Cacher évaluation des pairs';
$string['dynamorepbtevalbyothers']            = 'Afficher/Cacher évaluation par les pairs';
$string['dynamorepbtgraphradar']              = 'Afficher/Cacher radars';
$string['dynamorepbtgraphhisto']              = 'Afficher/Cacher histogrammes';
$string['dynamorepbtcomment']                 = 'Afficher/Cacher commentaires';
